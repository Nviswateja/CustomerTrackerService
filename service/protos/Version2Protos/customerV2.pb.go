...
type GetCustomerMessageRequestV2 struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GetCustomerMessageRequestV2) Reset() {
	*x = GetCustomerMessageRequestV2{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetCustomerMessageRequestV2) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetCustomerMessageRequestV2) ProtoMessage() {}

func (x *GetCustomerMessageRequestV2) ProtoReflect() protoreflect.Message {
	mi := &file_service_protos_Version2Protos_customerV2_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetCustomerMessageRequestV2.ProtoReflect.Descriptor instead.
func (*GetCustomerMessageRequestV2) Descriptor() ([]byte, []int) {
	return file_service_protos_Version2Protos_customerV2_proto_rawDescGZIP(), []int{1}
}

type CustomerDetailsV2Reply struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CustomerDetailsV2Reply) Reset() {
	*x = CustomerDetailsV2Reply{}
	if protoimpl.UnsafeEnabled {
...
func (x *CustomerDetailsV2Reply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CustomerDetailsV2Reply) ProtoMessage() {}

func (x *CustomerDetailsV2Reply) ProtoReflect() protoreflect.Message {
	mi := &file_service_protos_Version2Protos_customerV2_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CustomerDetailsV2Reply.ProtoReflect.Descriptor instead.
func (*CustomerDetailsV2Reply) Descriptor() ([]byte, []int) {
	return file_service_protos_Version2Protos_customerV2_proto_rawDescGZIP(), []int{2}
}

func (x *CustomerDetailsV2Reply) GetCustomers() []*Customer {
	if x != nil {
		return x.Customers
	}
	return nil
...
var file_service_protos_Version2Protos_customerV2_proto_rawDesc = []byte{
	...
	,
...
var file_service_protos_Version2Protos_customerV2_proto_goTypes = []interface{}{
	...
	(*GetCustomerMessageRequestV2)(nil), // 1: customerV2.GetCustomerMessageRequestV2
	(*CustomerDetailsV2Reply)(nil),      // 2: customerV2.CustomerDetailsV2Reply
}
var file_service_protos_Version2Protos_customerV2_proto_depIdxs = []int32{
	0, // 0: customerV2.CustomerDetailsV2Reply.customers:type_name -> customerV2.Customer
	1, // 1: customerV2.CustomerServiceV2.GetCustomerWithName:input_type -> customerV2.GetCustomerMessageRequestV2
	2, // 2: customerV2.CustomerServiceV2.GetCustomerWithName:output_type -> customerV2.CustomerDetailsV2Reply
...
func file_service_protos_Version2Protos_customerV2_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_service_protos_Version2Protos_customerV2_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCustomerMessageRequestV2); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_service_protos_Version2Protos_customerV2_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CustomerDetailsV2Reply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
